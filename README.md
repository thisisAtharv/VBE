...
4. **Database Setup:** Start your SQL server, create the required database, and update the connection credentials within the code.
5. **Run the App:** Execute the main application file (e.g., `Landing.java` or `Home.java`) to launch the GUI.
